...
function Header() {
  return (
    ...
    <nav className="bg-white border-indigo-500 py-2.5">
        <div className="flex flex-wrap justify-between mx-auto max-w-screen-xl">
            <a className="flex items-center">
                <img src={Logo} class="mr-3 h-6 sm:h-9" alt="PituChat Logo" />
                <span class="self-center text-xl font-semibold whitespace-nowrap">PITUCHAT</span>
            </a>
